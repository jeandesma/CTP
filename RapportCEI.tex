...
= L(2K + 1) - 2\left(\left\lfloor \frac{L}{K+1} \right\rfloor \sum_{i=1}^{K+1}i + \sum_{i=1}^{L-\left\lfloor \frac{L}{K+1} \right\rfloor}i\right)
\]
\begin{eqnarray}
&=& L(2K + 1) - 2\left(\left\lfloor \frac{L}{K+1} \right\rfloor\frac{(K+1)(K+2)}{2} + \frac{\left(L-\left\lfloor \frac{L}{K+1} \right\rfloor\right)\left(L-\left\lfloor \frac{L}{K+1} \right\rfloor + 1\right)}{2}\right)\nonumber \\
&=& L(2K + 1) - \left\lfloor \frac{L}{K+1} \right\rfloor(K+1)(K+2) - \left(L-\left\lfloor \frac{L}{K+1} \right\rfloor\right)\left(L-\left\lfloor \frac{L}{K+1} \right\rfloor + 1\right).\nonumber
\end{eqnarray}
...
\paragraph{} We note $\phi(K,L) = {L(2K + 1) - \left\lfloor \frac{L}{K+1} \right\rfloor(K+1)(K+2) -\left (L-\left\lfloor \frac{L}{K+1} \right\rfloor\right)\left(L-\left\lfloor \frac{L}{K+1} \right\rfloor + 1\right)}$.
